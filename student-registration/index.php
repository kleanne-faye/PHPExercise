...
<input type="number" class="form-control" name="card_no" placeholder="Enter Student ID (with dash)" maxlength="11" required>
</div>
<div class="form-group col-md-6">
<label for="inputPassword4">Mobile No.</label>
<input type="phone" class="form-control" name="user_phone" placeholder="Enter Mobile Number (+63***)" maxlength="13" required>
</div>
</div>
...
<input type="text" class="form-control" name="user_last_name" placeholder="Enter Middle Name">
</div>
</div>
</div>
...
<input type="text" class="form-control" name="user_father" placeholder="Enter Complete Name">
</div>
<div class="form-group col-md-6">
<label for="fathername">Occupation</label>
<input type="text" class="form-control" name="user_father" placeholder="Enter Occupation">
</div>
<div class="form-group col-md-6">
<label for="mothername">Mother's Name</label>
<input type="text" class="form-control" name="user_mother" placeholder="Enter Complete Name">
</div>
<div class="form-group col-md-6">
<label for="fathername">Occupation</label>
<input type="text" class="form-control" name="user_mother" placeholder="Enter Occupation">
</div>
<div class="form-group col-md-6">
<label for="fathername">Guardian</label>
<input type="text" class="form-control" name="user_guardian" placeholder="Enter Guardian's Name">
</div>
<div class="form-group col-md-6">
...
<select name="state" class="form-control">
  ...
  <option value="Abra">Abra</option>
									<option value="Apayao">Boliney</option>
